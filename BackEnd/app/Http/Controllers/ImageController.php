...
//        return response()->json($placeID->placeID);
        $image->insert(['placeID'=>$placeID->placeID,'imageName'=>'http://localhost:8000/upload/'.$file->upload($request->picture1),'main'=>1]);
        $image->insert(['placeID'=>$placeID->placeID,'imageName'=>'http://localhost:8000/upload/'.$file->upload($request->picture2),'main'=>0]);
        $image->insert(['placeID'=>$placeID->placeID,'imageName'=>'http://localhost:8000/upload/'.$file->upload($request->picture3),'main'=>0]);
        $image->insert(['placeID'=>$placeID->placeID,'imageName'=>'http://localhost:8000/upload/'.$file->upload($request->picture4),'main'=>0]);
